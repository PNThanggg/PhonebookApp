 ...
 *
 * @param activity has to be activity context to avoid some model.com.app.phonebook.base.compose.theme.model.Theme.AppCompat issues
...
class ConfirmationDialog(
    ...
    init {
        ...
        val builder = activity.getAlertDialogBuilder().setPositiveButton(positive) { _, _ -> dialogConfirmed() }
        ...
        builder.apply {
            activity.setupDialogStuff(
                view.root, this, titleText = dialogTitle, cancelOnTouchOutside = cancelOnTouchOutside
            ) { alertDialog ->
                dialog = alertDialog
            }
        }
...
fun ConfirmationAlertDialog(
    ...
    androidx.compose.material3.AlertDialog(containerColor = dialogContainerColor,
