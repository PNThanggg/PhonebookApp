...
class FastScrollerThumbView @JvmOverloads constructor(
    ...
    init {
        context.theme.obtainStyledAttributes(
            ...
            defStyleAttr,
            R.style.FastScroller
        ).use { attrsArray ->
            throwIfMissingAttrs(styleRes = R.style.FastScrollerThumb) {
    ...
    fun setupWithFastScroller(fastScrollerView: FastScrollerView) {
        check(!isSetup) { "Only set this view's com.app.phonebook.presentation.view.FastScrollerView once!" }
