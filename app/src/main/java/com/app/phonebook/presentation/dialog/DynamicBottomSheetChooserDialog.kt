...
import com.app.phonebook.base.view.BaseBottomSheetDialogFragment
import com.app.phonebook.base.view.SimpleListItemAdapter
import com.app.phonebook.data.models.SimpleListItem
import com.app.phonebook.databinding.LayoutSimpleRecyclerViewBinding
...
class DynamicBottomSheetChooserDialog : BaseBottomSheetDialogFragment() {
    ...
    private fun setupRecyclerView() {
        @Suppress("UNCHECKED_CAST") val listItems = arguments?.getParcelableArray(ITEMS) as Array<SimpleListItem>
    ...
    companion object {
        ...
        fun createChooser(
            fragmentManager: FragmentManager, title: Int?, items: Array<SimpleListItem>, callback: (SimpleListItem) -> Unit
