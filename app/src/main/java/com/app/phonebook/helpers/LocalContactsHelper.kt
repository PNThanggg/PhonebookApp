...
import com.app.phonebook.base.extension.contactsDB
...
class LocalContactsHelper(val context: Context) {
    ...
    private fun convertLocalContactToContact(
        localContact: LocalContact?, storedGroups: ArrayList<Group>
    ): Contact? {
    ...
    companion object {
        fun convertContactToSimpleContact(
            contact: Contact?, withPhoneNumbersOnly: Boolean
        ): SimpleContact? {
