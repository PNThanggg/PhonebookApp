...
import com.app.phonebook.interfaces.MyActionModeCallback
        ...
        actModeCallback = object : MyActionModeCallback() {
            ...
            override fun onCreateActionMode(actionMode: ActionMode, menu: Menu?): Boolean {
                ...
                actBarTextView!!.layoutParams =
                    ActionBar.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.MATCH_PARENT)
