...
import com.app.phonebook.databinding.ItemAddFavoriteWithNumberBinding
import com.app.phonebook.databinding.ItemAddFavoriteWithoutNumberBinding
...
class SelectContactsAdapter(
            ...
            itemBindingClass.bind(itemView).apply {
                ...
                contactNumber?.apply {
                    val phoneNumberToUse = if (textToHighlight.isEmpty()) {
                        ...
                        contact.phoneNumbers.firstOrNull { it.value.contains(textToHighlight) }
                            ?: contact.phoneNumbers.firstOrNull()
                    }
    ...
    private sealed interface Binding {
        ...
        data object WithNumber : Binding {
            ...
            ): ItemAddFavoriteBinding {
                return ItemAddFavoriteWithNumberBindingAdapter(
                    ItemAddFavoriteWithNumberBinding.inflate(
                        layoutInflater,
                        viewGroup,
                        attachToRoot
                    )
        ...
        data object WithoutNumber : Binding {
            override fun inflate(
                ...
                return ItemAddFavoriteWithoutNumberBindingAdapter(
                    ItemAddFavoriteWithoutNumberBinding.inflate(
                        layoutInflater,
                        viewGroup,
                        attachToRoot
                    )
    ...
    private class ItemAddFavoriteWithoutNumberBindingAdapter(val binding: ItemAddFavoriteWithoutNumberBinding) :
        ItemAddFavoriteBinding {
    ...
    private class ItemAddFavoriteWithNumberBindingAdapter(val binding: ItemAddFavoriteWithNumberBinding) :
        ItemAddFavoriteBinding {
        override val contactName: TextView = binding.contactName
