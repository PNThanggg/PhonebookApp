...
import com.app.phonebook.base.utils.ActionModeCallback
...
abstract class BaseRecyclerViewListAdapter<T>(
    ...
    val onRefresh: () -> Unit = {}
) : ListAdapter<T, BaseRecyclerViewListAdapter<T>.ViewHolder>(diffUtil) {
    ...
    protected var actModeCallback: ActionModeCallback
    ...
    init {
        actModeCallback = object : ActionModeCallback() {
