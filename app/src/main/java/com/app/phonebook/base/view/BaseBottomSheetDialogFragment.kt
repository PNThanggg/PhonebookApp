...
import com.app.phonebook.base.extension.setTextOrBeGone
import com.app.phonebook.databinding.DialogBottomSheetBinding
    ...
    override fun onCreateView(
        ...
        if (requireContext().isBlackAndWhiteTheme()) {
            view.root.background = ResourcesCompat.getDrawable(
                context.resources, R.drawable.bottom_sheet_bg_black, context.theme
            )
