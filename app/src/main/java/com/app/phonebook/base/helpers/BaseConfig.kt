...
import com.app.phonebook.base.utils.APP_ICON_COLOR
import com.app.phonebook.base.utils.APP_ID
import com.app.phonebook.base.utils.APP_PASSWORD_HASH
import com.app.phonebook.base.utils.APP_PASSWORD_PROTECTION
import com.app.phonebook.base.utils.APP_PROTECTION_TYPE
import com.app.phonebook.base.utils.APP_RUN_COUNT
import com.app.phonebook.base.utils.APP_SIDELOADING_STATUS
import com.app.phonebook.base.utils.AUTO_BACKUP
import com.app.phonebook.base.utils.AUTO_BACKUP_FILENAME
import com.app.phonebook.base.utils.AUTO_BACKUP_FOLDER
import com.app.phonebook.base.utils.BACKGROUND_COLOR
import com.app.phonebook.base.utils.BLOCK_HIDDEN_NUMBERS
import com.app.phonebook.base.utils.BLOCK_UNKNOWN_NUMBERS
import com.app.phonebook.base.utils.COLOR_PICKER_RECENT_COLORS
import com.app.phonebook.base.utils.CONFLICT_SKIP
import com.app.phonebook.base.utils.CONTACTS_GRID_COLUMN_COUNT
import com.app.phonebook.base.utils.CUSTOM_ACCENT_COLOR
import com.app.phonebook.base.utils.CUSTOM_APP_ICON_COLOR
import com.app.phonebook.base.utils.CUSTOM_BACKGROUND_COLOR
import com.app.phonebook.base.utils.CUSTOM_PRIMARY_COLOR
import com.app.phonebook.base.utils.CUSTOM_TEXT_COLOR
...
import com.app.phonebook.base.utils.DELETE_PASSWORD_HASH
import com.app.phonebook.base.utils.DELETE_PASSWORD_PROTECTION
import com.app.phonebook.base.utils.DELETE_PROTECTION_TYPE
import com.app.phonebook.base.utils.ENABLE_PULL_TO_REFRESH
import com.app.phonebook.base.utils.FAVORITES
...
import com.app.phonebook.base.utils.IS_USING_MODIFIED_APP_ICON
import com.app.phonebook.base.utils.IS_USING_SHARED_THEME
import com.app.phonebook.base.utils.IS_USING_SYSTEM_THEME
import com.app.phonebook.base.utils.KEEP_LAST_MODIFIED
import com.app.phonebook.base.utils.LAST_AUTO_BACKUP_TIME
import com.app.phonebook.base.utils.LAST_BLOCKED_NUMBERS_EXPORT_PATH
import com.app.phonebook.base.utils.LAST_CONFLICT_APPLY_TO_ALL
import com.app.phonebook.base.utils.LAST_CONFLICT_RESOLUTION
import com.app.phonebook.base.utils.LAST_COPY_PATH
import com.app.phonebook.base.utils.LAST_EXPORTED_SETTINGS_FOLDER
import com.app.phonebook.base.utils.LAST_EXPORT_PATH
import com.app.phonebook.base.utils.LAST_HANDLED_SHORTCUT_COLOR
import com.app.phonebook.base.utils.LAST_ICON_COLOR
import com.app.phonebook.base.utils.LAST_RENAME_PATTERN_USED
import com.app.phonebook.base.utils.LAST_RENAME_USED
...
import com.app.phonebook.base.utils.LAST_VERSION
...
import com.app.phonebook.base.utils.PASSWORD_COUNTDOWN_START_MS
import com.app.phonebook.base.utils.PASSWORD_HASH
import com.app.phonebook.base.utils.PASSWORD_PROTECTION
import com.app.phonebook.base.utils.PASSWORD_RETRY_COUNT
import com.app.phonebook.base.utils.PREVENT_PHONE_FROM_SLEEPING
...
import com.app.phonebook.base.utils.PROTECTED_FOLDER_HASH
import com.app.phonebook.base.utils.PROTECTED_FOLDER_TYPE
import com.app.phonebook.base.utils.PROTECTION_NONE
import com.app.phonebook.base.utils.PROTECTION_PATTERN
import com.app.phonebook.base.utils.PROTECTION_TYPE
import com.app.phonebook.base.utils.RENAME_SIMPLE
import com.app.phonebook.base.utils.SCROLL_HORIZONTALLY
...
import com.app.phonebook.base.utils.SHOULD_USE_SHARED_THEME
...
import com.app.phonebook.base.utils.SHOW_DIALPAD_BUTTON
...
import com.app.phonebook.base.utils.SHOW_INFO_BUBBLE
...
import com.app.phonebook.base.utils.SIDELOADING_UNCHECKED
import com.app.phonebook.base.utils.SKIP_DELETE_CONFIRMATION
import com.app.phonebook.base.utils.SNOOZE_TIME
import com.app.phonebook.base.utils.SORT_FOLDER_PREFIX
...
import com.app.phonebook.base.utils.SUNDAY_FIRST
...
import com.app.phonebook.base.utils.USE_ENGLISH
import com.app.phonebook.base.utils.USE_SAME_SNOOZE
import com.app.phonebook.base.utils.VIBRATE_ON_BUTTON_PRESS
import com.app.phonebook.base.utils.VIEW_TYPE
import com.app.phonebook.base.utils.VIEW_TYPE_LIST
import com.app.phonebook.base.utils.WAS_ALARM_WARNING_SHOWN
import com.app.phonebook.base.utils.WAS_APP_ICON_CUSTOMIZATION_WARNING_SHOWN
import com.app.phonebook.base.utils.WAS_APP_ON_SD_SHOWN
import com.app.phonebook.base.utils.WAS_APP_RATED
import com.app.phonebook.base.utils.WAS_BEFORE_ASKING_SHOWN
import com.app.phonebook.base.utils.WAS_BEFORE_RATE_SHOWN
import com.app.phonebook.base.utils.WAS_CUSTOM_THEME_SWITCH_DESCRIPTION_SHOWN
import com.app.phonebook.base.utils.WAS_FOLDER_LOCKING_NOTICE_SHOWN
import com.app.phonebook.base.utils.WAS_INITIAL_UPGRADE_TO_PRO_SHOWN
import com.app.phonebook.base.utils.WAS_LOCAL_ACCOUNT_INITIALIZED
import com.app.phonebook.base.utils.WAS_MESSENGER_RECORDER_SHOWN
import com.app.phonebook.base.utils.WAS_ORANGE_ICON_CHECKED
import com.app.phonebook.base.utils.WAS_OTG_HANDLED
import com.app.phonebook.base.utils.WAS_RATE_US_PROMPT_SHOWN
import com.app.phonebook.base.utils.WAS_REMINDER_WARNING_SHOWN
...
import com.app.phonebook.base.utils.WAS_SORTING_BY_NUMERIC_VALUE_ADDED
import com.app.phonebook.base.utils.WAS_UPGRADED_FROM_FREE_SHOWN
import com.app.phonebook.base.utils.WAS_USE_ENGLISH_TOGGLED
import com.app.phonebook.base.utils.WIDGET_BG_COLOR
import com.app.phonebook.base.utils.WIDGET_ID_TO_MEASURE
import com.app.phonebook.base.utils.WIDGET_TEXT_COLOR
...
open class BaseConfig(private val context: Context) {
    ...
    var widgetBgColor: Int
        get() = prefs.getInt(
            WIDGET_BG_COLOR, ContextCompat.getColor(context, R.color.default_widget_bg_color)
        )
        set(widgetBgColor) = prefs.edit().putInt(WIDGET_BG_COLOR, widgetBgColor).apply()

    var widgetTextColor: Int
        get() = prefs.getInt(
            WIDGET_TEXT_COLOR, ContextCompat.getColor(context, R.color.default_widget_text_color)
        )
...
//    val wasUseEnglishToggledFlow = ::wasUseEnglishToggled.asFlowNonNull()
    ...
    fun saveCustomSorting(path: String, value: Int) {
        if (path.isEmpty()) {
            ...
            prefs.edit().putInt(SORT_FOLDER_PREFIX + path.lowercase(Locale.ROOT), value).apply()
        }
    }
    ...
    fun removeCustomSorting(path: String) {
        prefs.edit().remove(SORT_FOLDER_PREFIX + path.lowercase(Locale.ROOT)).apply()
    }
    ...
    var vibrateOnButtonPress: Boolean
        get() = prefs.getBoolean(
            VIBRATE_ON_BUTTON_PRESS, context.resources.getBoolean(R.bool.default_vibrate_on_press)
        )
...
//    val colorPickerRecentColorsFlow = ::colorPickerRecentColors.asFlowNonNull()
    ...
    var showContactFields: Int
        get() = prefs.getInt(
            SHOW_CONTACT_FIELDS,
            SHOW_FIRST_NAME_FIELD or SHOW_SURNAME_FIELD or SHOW_PHONE_NUMBERS_FIELD or SHOW_EMAILS_FIELD or SHOW_ADDRESSES_FIELD or SHOW_EVENTS_FIELD or SHOW_NOTES_FIELD or SHOW_GROUPS_FIELD or SHOW_CONTACT_SOURCE_FIELD
        )
...
//    private fun <T> KProperty0<T>.asFlow(emitOnCollect: Boolean = false): Unit =
