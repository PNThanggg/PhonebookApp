...
fun String.getMimeType(): String {
    val typesMap = HashMap<String, String>().apply {
        ...
        put("com.app.phonebook.base.compose.extensions.getConfig", "application/xml")
        ...
        put("dll.com.app.phonebook.base.compose.extensions.getConfig", "text/xml")
        put("dlm", "text/dlm")
        ...
        put("exe.com.app.phonebook.base.compose.extensions.getConfig", "text/xml")
